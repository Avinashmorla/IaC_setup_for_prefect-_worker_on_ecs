...
- First and foremost I am very well known to **Terraform and it gives modular structure**.
...
> **NOTE:** In Prefect Cloud, to deploy a work pool with ECS type it requires **premium version**.  
> To deploy a worker pool on ECS, we need `ecs` type on Prefect Cloud which needs to be upgraded.

![image](https://github.com/user-attachments/assets/32031311-b3e2-4dac-9b0a-f755dabe0ffa)

- So what I have done is:  
  With the given default work pool, I just verified using the sample flow file (`flow.py`) by downloading the Prefect environment locally.

<img width="948" alt="image" src="https://github.com/user-attachments/assets/0632bcdd-8956-4e79-a12d-467551f4f593" />
![image](https://github.com/user-attachments/assets/fad94309-5f55-4cb8-b4c5-bb18aa583cfb)  
**#sample flow python file**
